    ...
    <div style="margin-top: 10px">
      <el-table :data="salaries" border stripe>
        ...
        <el-table-column label="失业保险" align="center">
          <el-table-column width="70" prop="unemployBasePer" label="比率"></el-table-column>
          <el-table-column width="70" prop="unemployBase" label="基数"></el-table-column>
        </el-table-column>
        <el-table-column label="工伤保险" align="center">
          <el-table-column width="70" prop="jobInjuryPer" label="比率"></el-table-column>
          <el-table-column width="70" prop="jobInjuryBase" label="基数"></el-table-column>
        </el-table-column>
        <el-table-column label="生育保险" align="center">
          <el-table-column width="70" prop="birthPer" label="比率"></el-table-column>
          <el-table-column width="70" prop="birthBase" label="基数"></el-table-column>
        </el-table-column>
